...
public final class FreeColClient {
	...
	/**
	 * Indicated whether or not there is an open connection to the server. This is
	 ...
	 * @param spec
	 *            If non-null, a <code>Specification</code> to use to start a new
	 *            game immediately.
	 */
	 ...
	 * (data/base/client-options.xml) 2) Standard action manager actions 3) Saved
	 * game 4) User options
	 *
	 ...
	 *
	 * @return The <code>FreeColServer</code> or <code>null</code> if no server has
	 *         been started.
	 */
	...
	/**
	 * Sets the <code>FreeColServer</code> which has been started by the client gui.
	 *
	 * @param freeColServer
	...
	/**
	 * Updates the game actions. Generally useful when menu actions should change
	 * due to the current game context.
	 */
	 ...
	 *
	 * Clients that do not have the server running, or that have not the required
	 * permissions cannot save and should have the menu entry disabled
	 *
	...
	/**
	 * If currently in a game, displays a quit dialog and if desired, logs out of
	 * the current game.
	 *
