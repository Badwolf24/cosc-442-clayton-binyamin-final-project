...
public final class ConnectController {
	 ...
	 *
	 * @param host
	 *            The name of the machine running the <code>FreeColServer</code>.
	 * @param port
	 ...
	 *
	 * @param notifyServer
	 *            Whether or not the server should be notified of the logout. For
	 *            example: if the server kicked us out then we don't need to confirm
	 *            with a logout message.
	 */
	 ...
	 * stopServer is <i>true</i>. The server and perhaps the clients (if a server is
	 * running through this client and stopServer is true) will be notified.
	 *
	 * @param stopServer
