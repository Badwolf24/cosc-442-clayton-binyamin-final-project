...
public class GUI {
	 ...
	 * 
	 * FIXME: Delete all code inside this method and replace it with sensible code
	 * directly drawing in necessary size, without creating a throwaway GUI panel,
	 * drawing in wrong size and immediately resizing.
	 * 
	...
	/**
	 * If a unit has a trade route, get confirmation that it is ok to clear it and
	 * set a destination.
	 *
	 * @param unit
	 *            The <code>Unit</code> to check.
	...
	/**
	 * Check if an attack results in a transition from peace or cease fire to war
	 * and, if so, warn the player.
	 *
	 * @param attacker
	 *            The potential attacking <code>Unit</code>.
	 * @param target
	...
	/**
	 * Shows the pre-combat dialog if enabled, allowing the user to view the odds
	 * and possibly cancel the attack.
	 *
	 * @param attacker
	 *            The attacking <code>Unit</code>.
	 * @param tile
	...
	/**
	 * Get the user choice of whether to pay arrears for boycotted goods or to dump
	 * them instead.
	 *
	 * @param goods
	 ...
	 * @param template
	 *            A <code>StringTemplate</code> containing the message to display.
	 * @param canBuy
	 *            Show a "buy" option.
	 * @param canSell
	 *            Show a "sell" option.
	 ...
	 * @return The selected value of the selected <code>ChoiceItem</code>, or null
	 *         if cancelled.
	 */
	...
	/**
	 * Wrapper for SwingUtilities.invokeAndWait that handles the case where we are
	 * already in the EDT.
	 *
	 * @param runnable
	 *            A <code>Runnable</code> to run.
