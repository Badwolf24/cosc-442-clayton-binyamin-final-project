...
public abstract class FreeColAction extends AbstractAction implements Option<FreeColAction> {
	...
	/**
	 * A class used by Actions which have a mnemonic. Those Actions should assign
	 * this listener to the JMenuItem they are a part of. This captures the mnemonic
	 * key press and keeps other menus from processing keys meant for other actions.
	 *
	 * @author johnathanj
	 */
	 ...
	 *
	 * @param accelerator
	 *            The <code>KeyStroke</code>. Using <code>null</code> is the same as
	 *            disabling the keyboard accelerator.
	 */
	...
	/**
	 * Gives a short description of this <code>Option</code>. Can for instance be
	 * used as a tooltip text.
	 *
	 ...
	 * <code>KeyStroke</code>. This <code>String</code> can be used to store the key
	 * stroke in an XML-file.
	 *
	 * @param keyStroke
	 *            The <code>KeyStroke</code>.
	 * @return A <code>String</code> that produces a key stroke equal to the given
	 *         <code>KeyStroke</code> if passed as a parameter to
	 ...
	 *
	 * FIXME: at the moment, this is only necessary in order to implement Option.
	 *
	 ...
	 *
	 * @return True if the
	 *         {@link net.sf.freecol.client.gui.panel.ClientOptionsDialog} is not
	 *         visible.
	 */
