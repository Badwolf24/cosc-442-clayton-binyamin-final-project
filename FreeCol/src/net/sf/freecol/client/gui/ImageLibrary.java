...
public final class ImageLibrary {
	 ...
	 * tolerate changing sizes in the files. Most other images are currently still
	 * shown in a size of image size times scaling factor times requested size.
	 */
	 ...
	 * <code>1</code> is used if this object is not a result of a scaling operation.
	 */
	 ...
	 * 
	 * Please avoid using too many different scaling factors, as this will lead to
	 * wasted memory for caching images in ResourceManager! Currently, 0.25, 0.5,
	 * ..., 2.0 are used for the map. Colony tiles and the GUI use 1.0 here (maybe
	 * also 1.25, 1.5, 1.75 and 2.0 in future), but this gets multiplied for tiny
	 * 0.25(rarely, candidate for removal), smaller 0.5, small 0.75 and normal 1.0
	 * image retrieval methods.
	 * 
	 * @param scaleFactor
	 *            The factor used when scaling. 2 is twice the size of the original
	 *            images and 0.5 is half.
	 */
	 ...
	 * It is 1 if the constructor without scaling factor was used to create this
	 * object.
	 * 
	 ...
	 *
	 * Our eyes have different sensitivity towards red, green and blue. We want a
	 * foreground color with the inverse brightness.
	 *
	 * @param background
	...
	/**
	 * The string border colors should be black unless the color of the string is
	 * really dark.
	 *
	 * @param color
	 ...
	 * "even". This is useful to select different images for the same tile type in
	 * order to prevent big stripes or a checker-board effect.
	 *
	 * @param x
	 ...
	 * @param x
	 *            The x-coordinate of the location of the tile that is being drawn.
	 * @param y
	 *            The x-coordinate of the location of the tile that is being drawn.
	...
	/**
	 * Returns the appropriate BufferedImage for a FreeColObject. Please, use a more
	 * specific method!
	 *
	 * @param display
	...
	/**
	 * Returns the overlay-image for the given type and scale. Currently used for
	 * hills and mountains.
	 *
	 * @param type
	 *            The type of the terrain-image to return.
	 ...
	 * specified by a component, tiling the image to fill up the space. If the image
	 * is not available, just fill with the background colour.
	 *
	 * @param resource
	...
	/**
	 * Gets a chip image for the alarm at an Indian settlement. The background is
	 * either the native owner's, or that of the most hated nation if any.
	 *
	 * @param g
	 *            Graphics2D for getting the FontMetrics.
	 * @param is
	...
	/**
	 * Gets an image with a string of a given color and with a black border around
	 * the glyphs.
	 *
	 * @param g
